...
create_figure('Figure 1: Dirichlet Partitioner Mean Accuracy Comparisons (Bar Plot Tail 10 with Error Bars)', 'drichlet')
create_figure('Figure 2: Pathological Partitioner Mean Accuracy Comparisons (Bar Plot Tail 10 with Error Bars)', 'pathological')

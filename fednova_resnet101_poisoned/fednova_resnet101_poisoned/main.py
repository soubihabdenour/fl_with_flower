...
from fednova_resnet101_poisoned.client import get_client_fn
from fednova_resnet101_poisoned.dataset import get_data
from fednova_resnet101_poisoned.server import fit_config, weighted_average, get_evaluate_fn
...
def main(cfg: DictConfig):
    ...
    history = fl.simulation.start_simulation(
        client_fn=get_client_fn(fds, num_classes=cfg.model.num_classes, config_fit=cfg.config_fit, poison_fraction=cfg.poison_fraction, mal_ids=mal_ids),

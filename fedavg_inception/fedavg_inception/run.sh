...
python -m fedavg_inception.main dataset.partitioner.name="PathologicalPartitioner"
...
python -m fedavg_inception.main dataset.partitioner.name="DirichletPartitioner"
# Check if Experiment 2 succeeded
if [ $? -ne 0 ]; then
...
python -m fedavg_inception.main

...
python -m fedavg_vgg16.main dataset.partitioner.name="PathologicalPartitioner"
...
python -m fedavg_vgg16.main dataset.partitioner.name="DirichletPartitioner"
# Check if Experiment 2 succeeded
if [ $? -ne 0 ]; then
